/* PrismJS 1.19.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+bash+c+csharp+cpp+django+git+go+java+kotlin+markup-templating+php+python&plugins=line-numbers+show-language+highlight-keywords+toolbar+copy-to-clipboard */
newFunction();
